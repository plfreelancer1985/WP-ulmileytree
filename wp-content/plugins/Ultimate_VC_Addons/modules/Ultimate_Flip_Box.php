		...
		function block_shortcode($atts)
		{
			...
			$output .= '<div class="ifb-flip-box">';
				$output .= '<div class="ifb-face ifb-front" style="'.$f_style.' '.$box_border.' '.$border_front.'">
						...
						if($block_desc_front!='')
							$output.='<div class="ifb-flip-box-section-content" style="'.$desc_style.'"><p>'.$block_desc_front.'</p></div>';
					$output.='</div></div><!-- END .front -->
						<div class="ifb-face ifb-back" style="'.$b_style.' '.$box_border.' '.$border_back.'">
							...
							if($block_desc_back!=''){
								...
								$output.='<div class="ifb-flip-box-section-content" style="'.$desc_style.'"><p>'.$block_desc_back.'</p></div>';
								if($button_link !== ''){
									$output .= '</div>';
								}
							}
